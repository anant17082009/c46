...
enemy1.velocityX = Math.round(random(5,7))
enemy2.velocityX = Math.round(random(-5,-7))
enemy3.velocityY = Math.round(random(5,7))
enemy4.velocityY = Math.round(random(5,7))
enemy5.velocityY = Math.round(random(-5,-7))
enemy6.velocityX = Math.round(random(5,7))
enemy7.velocityX = Math.round(random(5,7))
    ...
    swal(
      {
        ...
        text: "Thanks for playing!!",
        imageUrl:
          "https://www.alamy.com/boy-holding-gold-trophy-image186082021.html",
        imageSize: "150x150",
        confirmButtonText: "Play Again !!"
      },
      function(isConfirm) {
